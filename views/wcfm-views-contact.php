...
<div class="collapse wcfm-collapse" id="wcfm_contact_listing">
	...
	<div class="wcfm-page-headig">
		...
		<span class="wcfm-page-heading-text"><?php _e( 'Failed', 'wcfm-custom-menus' ); ?></span>
	...
	<div class="wcfm-collapse-content">
		...
		<div class="wcfm-container wcfm-top-element-container">
			<h2><?php _e('Failure', 'wcfm-custom-menus' ); ?></h2>
	  ...
	  <div class="wcfm-clearfix"></div><br />
		...
		<div class="wcfm-container">
			<div id="wcfm_contact_listing_expander" class="wcfm-content">
				...
				<!---- Add Content Here ----->
				<p style="text-align:center;">That one failed. Sorry! :(</p>
